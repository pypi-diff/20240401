# Comparing `tmp/qodex_cameras-2.1.4-py3-none-any.whl.zip` & `tmp/qodex_cameras-2.1.5-py3-none-any.whl.zip`
...
## Comparing `qodex_cameras-2.1.4.dist-info/LICENSE` & `qodex_cameras-2.1.5.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `qodex_cameras-2.1.4.dist-info/RECORD` & `qodex_cameras-2.1.5.dist-info/RECORD`
