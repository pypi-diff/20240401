# Comparing `tmp/froggius-0.1.3.tar.gz` & `tmp/froggius-0.1.3.post1.tar.gz`
...
## Comparing `froggius-0.1.3.tar` & `froggius-0.1.3.post1.tar`
...
### Comparing `froggius-0.1.3/LICENSE` & `froggius-0.1.3.post1/LICENSE`

 * *Files identical despite different names*

### Comparing `froggius-0.1.3/README.md` & `froggius-0.1.3.post1/README.md`
...
### Comparing `froggius-0.1.3/froggius/logger.py` & `froggius-0.1.3.post1/froggius/logger.py`
...
### Comparing `froggius-0.1.3/setup.py` & `froggius-0.1.3.post1/setup.py`
