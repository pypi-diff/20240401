# Comparing `tmp/creyPY-0.0.6.tar.gz` & `tmp/creyPY-0.0.7.tar.gz`
...
## Comparing `creyPY-0.0.6.tar` & `creyPY-0.0.7.tar`
...
### Comparing `creyPY-0.0.6/LICENSE` & `creyPY-0.0.7/LICENSE`

 * *Files identical despite different names*

### Comparing `creyPY-0.0.6/creyPY/const/i18n.py` & `creyPY-0.0.7/creyPY/const/i18n.py`

 * *Files identical despite different names*

### Comparing `creyPY-0.0.6/creyPY/const/stripe.py` & `creyPY-0.0.7/creyPY/const/stripe.py`

 * *Files identical despite different names*

### Comparing `creyPY-0.0.6/creyPY/fastapi/pagination.py` & `creyPY-0.0.7/creyPY/fastapi/pagination.py`
