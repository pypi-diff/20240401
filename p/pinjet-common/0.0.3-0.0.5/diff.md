# Comparing `tmp/pinjet-common-0.0.3.tar.gz` & `tmp/pinjet-common-0.0.5.tar.gz`
...
## Comparing `pinjet-common-0.0.3.tar` & `pinjet-common-0.0.5.tar`
...
### Comparing `pinjet-common-0.0.3/LICENSE` & `pinjet-common-0.0.5/LICENSE`
