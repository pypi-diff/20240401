# Comparing `tmp/utils_huna-0.1.1.tar.gz` & `tmp/utils_huna-0.1.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "utils_huna-0.1.1.tar", last modified: Mon Apr  1 14:36:32 2024, max compression
+gzip compressed data, was "utils_huna-0.1.2.tar", last modified: Mon Apr  1 15:18:19 2024, max compression
```

## Comparing `utils_huna-0.1.1.tar` & `utils_huna-0.1.2.tar`

### file list

```diff
@@ -1,10 +1,18 @@
-drwxr-xr-x   0 jupyter   (1005) jupyter   (1006)        0 2024-04-01 14:36:32.190292 utils_huna-0.1.1/
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)       98 2024-04-01 14:36:32.190292 utils_huna-0.1.1/PKG-INFO
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)      326 2024-03-18 14:37:13.000000 utils_huna-0.1.1/README.md
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)       38 2024-04-01 14:36:32.190292 utils_huna-0.1.1/setup.cfg
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)      204 2024-04-01 14:35:21.000000 utils_huna-0.1.1/setup.py
-drwxr-xr-x   0 jupyter   (1005) jupyter   (1006)        0 2024-04-01 14:36:32.190292 utils_huna-0.1.1/utils_huna.egg-info/
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)       98 2024-04-01 14:36:32.000000 utils_huna-0.1.1/utils_huna.egg-info/PKG-INFO
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)      154 2024-04-01 14:36:32.000000 utils_huna-0.1.1/utils_huna.egg-info/SOURCES.txt
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)        1 2024-04-01 14:36:32.000000 utils_huna-0.1.1/utils_huna.egg-info/dependency_links.txt
--rw-r--r--   0 jupyter   (1005) jupyter   (1006)        1 2024-04-01 14:36:32.000000 utils_huna-0.1.1/utils_huna.egg-info/top_level.txt
