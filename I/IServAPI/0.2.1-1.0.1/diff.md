# Comparing `tmp/IServAPI-0.2.1.tar.gz` & `tmp/IServAPI-1.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "IServAPI-0.2.1.tar", last modified: Wed Mar 27 09:10:16 2024, max compression
+gzip compressed data, was "IServAPI-1.0.1.tar", last modified: Mon Apr  1 14:54:20 2024, max compression
```

## Comparing `IServAPI-0.2.1.tar` & `IServAPI-1.0.1.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-03-27 09:10:16.877115 IServAPI-0.2.1/
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-03-27 09:10:16.877115 IServAPI-0.2.1/IServAPI.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     9399 2024-03-27 09:10:16.000000 IServAPI-0.2.1/IServAPI.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      212 2024-03-27 09:10:16.000000 IServAPI-0.2.1/IServAPI.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-03-27 09:10:16.000000 IServAPI-0.2.1/IServAPI.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       58 2024-03-27 09:10:16.000000 IServAPI-0.2.1/IServAPI.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)        9 2024-03-27 09:10:16.000000 IServAPI-0.2.1/IServAPI.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)    39607 2024-03-27 09:10:06.000000 IServAPI-0.2.1/IServAPI.py
--rw-r--r--   0 runner    (1001) docker     (127)     1055 2024-03-27 09:10:06.000000 IServAPI-0.2.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)     9399 2024-03-27 09:10:16.877115 IServAPI-0.2.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     8777 2024-03-27 09:10:06.000000 IServAPI-0.2.1/README.md
--rw-r--r--   0 runner    (1001) docker     (127)      104 2024-03-27 09:10:06.000000 IServAPI-0.2.1/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-03-27 09:10:16.877115 IServAPI-0.2.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      845 2024-03-27 09:10:06.000000 IServAPI-0.2.1/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-01 14:54:20.252632 IServAPI-1.0.1/
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-01 14:54:20.252632 IServAPI-1.0.1/IServAPI.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)     9270 2024-04-01 14:54:20.000000 IServAPI-1.0.1/IServAPI.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      212 2024-04-01 14:54:20.000000 IServAPI-1.0.1/IServAPI.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-01 14:54:20.000000 IServAPI-1.0.1/IServAPI.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       58 2024-04-01 14:54:20.000000 IServAPI-1.0.1/IServAPI.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        9 2024-04-01 14:54:20.000000 IServAPI-1.0.1/IServAPI.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (127)    41036 2024-04-01 14:54:14.000000 IServAPI-1.0.1/IServAPI.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1055 2024-04-01 14:54:14.000000 IServAPI-1.0.1/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (127)     9270 2024-04-01 14:54:20.252632 IServAPI-1.0.1/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)     8648 2024-04-01 14:54:14.000000 IServAPI-1.0.1/README.md
+-rw-r--r--   0 runner    (1001) docker     (127)      104 2024-04-01 14:54:14.000000 IServAPI-1.0.1/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-01 14:54:20.252632 IServAPI-1.0.1/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (127)      845 2024-04-01 14:54:14.000000 IServAPI-1.0.1/setup.py
```

### Comparing `IServAPI-0.2.1/IServAPI.egg-info/PKG-INFO` & `IServAPI-1.0.1/IServAPI.egg-info/PKG-INFO`
...
### Comparing `IServAPI-0.2.1/IServAPI.py` & `IServAPI-1.0.1/IServAPI.py`
...
-        resonse = self.session.get(f"https://{self.iserv_url}/iserv/addressbook/public?filter%5Bsearch%5D={query}", allow_redirects=True)
...
-                logging.info("Email sent successfully via SMTPS (port {}).".format(smtps_port))
+                logging.info(
...
+        A function to retrieve user information from a given URL and parse it into a dictionary.
         ...
         """
-        response = self.session.get(f"https://{self.iserv_url}/iserv/addressbook/public/show/{user}")
...
### Comparing `IServAPI-0.2.1/LICENSE` & `IServAPI-1.0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `IServAPI-0.2.1/PKG-INFO` & `IServAPI-1.0.1/PKG-INFO`
...
### Comparing `IServAPI-0.2.1/README.md` & `IServAPI-1.0.1/README.md`
...
### Comparing `IServAPI-0.2.1/setup.py` & `IServAPI-1.0.1/setup.py`
